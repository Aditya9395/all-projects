...
class MarvellousLogin extends Template implements ActionListener,Runnable
{
    ...
    MarvellousLogin()
    {
        ...
        Dimension topsize = TopLabel.getPreferedSize();
        ...
        Dimension size = label1.getPreferedSize();

        label1.setBounds(50,135,size,width,size.height);
        lebel1.setHorizontalAlignment(SwingConstants.CENTER);

        text1 = new JTextField(15);
        Dimension tsize = text1.getPreferedSize();
        text1.setBounds(200,135,tsize.width,tsize.height);

        text1.setToolTipText("ENTER USERNAME");

        label2 = new JLabel();
        leble2.setText("Password:");
        leble2.setBounds(50,175,size.width,size.height);
        leble2.setForeground(Colour.white);
        leble2.setHorizontalAlignment(SwingConstants.CENTER);
        ...
        Dimension ssize = SUBMIT.getPreferedSize();
        ...
        Dimension l3size = label3.getPreferedSize();
